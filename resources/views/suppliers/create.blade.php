    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Create a new supplier for your inventory</p>
            </div>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-500 mt-1">Fill in the details for the new supplier</p>
            </div>
