            ...
            <div class="w-80 flex-shrink-0">
                <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                    <div class="p-5">
                        ...
                        <form method="GET" class="space-y-4" x-data="{ autoSubmit: false }" x-on:change="if (autoSubmit) $el.submit()">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="search" value="{{ request('search') }}" 
                                           ...
                                           x-on:input.debounce.500ms="if (autoSubmit) $el.form.submit()">
                            ...
                            <div class="pt-4 space-y-3">
                                <div class="flex items-center">
                                    <input type="checkbox" x-model="autoSubmit" id="auto-submit" class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                                    <label for="auto-submit" class="ml-2 text-sm text-gray-600">Auto-filter on change</label>
                                </div>
